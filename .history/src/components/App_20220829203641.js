...
const handleClick = (e) => {
  ...
  const test = e.target.src
  console.log(test.split('/').pop().split('.')[0]) // split the src based on "/" then remove the last element, then split that element based on "." then choose the 1st element
}
